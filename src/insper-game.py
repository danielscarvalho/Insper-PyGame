...
#TODO: Refazer (refactor) o programa utilizando classes (OO - Orienta��o a Objetos)
#TODO: Criar novas fases do jogo utilizando os diversos sprites (imagens) dispon�veis
#TODO: Possibilitar trocar de avatar: rosa, verde e azul
#TODO: Criar tela inicial (splash screen)
#TODO: Criar menu e tela de configura��o
...
class Position:
    def __init__(self): #m�todo construtor da classe
        tileSize = 70 #tamanho b�sico dos sprites (imagens)
        alpha = ["A","B","C","D","E","F","G","H","I","J"] # 700/70 posi��es discretas eixo y - vertical
    ...
    def getOrdinate(self, y):
        return self.ordinate[y] # retorna valor para intervalo de A � J
